...
bgColor: bg-pink-500
github: job-portal
tags: ["Railway", "Typescript", "Vite", "Turbo-Repo", "Monorepo", "Tailwind CSS", "Shadcn UI", "CSS", "Redux", "Socket IO", "Redis", "Redux Toolkit", "RTK Query", "Zod", "JWT Authentication", "Radix-UI", "ExpressJS", "Framer Motion", "Prettier", "MongoDB", "Nodemailer", "Git", "Microsoft Azure", "Azure App Service", "Github Actions"]
status: completed
order: 1
---
